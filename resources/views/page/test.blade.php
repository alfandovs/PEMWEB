...
<div class="container" style="margin-top: 30px; margin-bottom: 90px;">
	<div class="jumbotron" style="background-color: #FFF;">
		<p style="font-weight: bold;">SOAL TEST RMIB</p>
		<hr>
					...
					<div class="card-body">
						<table width="100%">
							<tr>
								...
								<td><h6 class="card-title" style="font-weight: bold; color: #9A9797;">Gambaran Pekerjaan</h6></td>
							</tr>
							@php
							$huruf = ['A', 'B', 'C' , 'D'];
							$num = -1;
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">Tutorial RMIB TEST</h5>
