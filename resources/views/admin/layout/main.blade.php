        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{asset('admin/image/user.png')}}" class="user-image" alt="User Image">
              <span class="hidden-xs">Natt Patterson</span>
            </a>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="{{ (request()->segment(2) == 'usertest') ? 'active' : '' }}"><a href="{{url('/disc/usertest')}}"><i class="fa fa-users"></i> <span>User Test</span></a></li>
         <li class="{{ (request()->segment(2) == 'datamaster') ? 'active' : '' }}"><a href="{{url('/disc/datamaster')}}"><i class="fa fa-users"></i> <span>Data Users</span></a></li>
         <li class="{{ (request()->segment(2) == 'jadwal') ? 'active' : '' }}"><a href="{{url('/disc/jadwal')}}"><i class="fa fa-users"></i> <span>Jadwal Tes</span></a></li>
